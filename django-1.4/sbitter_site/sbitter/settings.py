# Django settings for sbitter project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'sbitter',                      # Or path to database file if using sqlite3.
        'USER': 'sbitter_user',                      # Not used with sqlite3.
        'PASSWORD': '5K7VBxI5PGu6nu2Be#r5SwlLLshUiu',                  # Not used with sqlite3.
...
SECRET_KEY = 'TVm;B1dJlN6JEnma?/z.DW\rd=QD\}t5H`QTnkJm2.uI(^?IrU'
...
ROOT_URLCONF = 'sbitter.urls'

WSGI_APPLICATION = 'sbitter.wsgi.application'
