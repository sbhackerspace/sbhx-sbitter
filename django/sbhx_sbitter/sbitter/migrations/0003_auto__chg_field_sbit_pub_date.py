...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SBit.pub_date'
        db.alter_column('sbitter_sbit', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))


    def backwards(self, orm):
        
        # Changing field 'SBit.pub_date'
        db.alter_column('sbitter_sbit', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
