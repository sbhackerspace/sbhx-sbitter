...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SBitter.modified_at'
        db.alter_column('sbitter_sbitter', 'modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'SBitter.modified_at'
        db.alter_column('sbitter_sbitter', 'modified_at', self.gf('django.db.models.fields.DateTimeField')())
